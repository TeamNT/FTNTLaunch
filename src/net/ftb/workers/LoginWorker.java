...
*
* Copyright © 2013-2014, FTB Launcher Contributors <https://github.com/Slowpoke101/FTBLaunch/>
...
public class LoginWorker extends SwingWorker<String, Void> {
        ...
        protected String doInBackground() {
                try {
                	return (AppUtils.downloadString(new URL("https://login.minecraft.net/?user=" + URLEncoder.encode(username, "UTF-8") + "&password=" + URLEncoder.encode(password, "UTF-8") + "&version=13"))).replace("Bad login", "0:deprecated:" + username + ":0:0");
                } catch(IOException e) {
